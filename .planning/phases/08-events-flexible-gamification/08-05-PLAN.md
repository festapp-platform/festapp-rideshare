...
@.planning/phases/08-events-flexible-gamification/08-04-SUMMARY.md
@packages/shared/src/index.ts
...
<task type="auto">
  ...
  <action>
    ...
    **Impact dashboard share integration:**
    ...
    - Share text: "I've saved {co2} kg CO2 and completed {rides} shared rides on Festapp!"
...
<output>
After completion, create `.planning/phases/08-events-flexible-gamification/08-05-SUMMARY.md`
</output>
